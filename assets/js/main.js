...
// ----------------------------------------------
// TESTIMONIALS FADE-IN LOGIC (Multiple Containers Safe)
// ----------------------------------------------
...
function initTestimonials() {
  ...
  function fadeAndLoad(container, testimonials) {
    ...
    buttonContainer.innerHTML = `
      <a href="#" class="button next testimonial-reload">More testimonials ↻</a>
    `;

    buttonContainer.querySelector(".testimonial-reload").addEventListener("click", (e) => {
      e.preventDefault();
      fadeAndLoad(container, testimonials);
    });
  }

  // Dynamically determine base path for JSON
